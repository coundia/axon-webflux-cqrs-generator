...
import com.groupe2cs.generator.service.FindByFieldQueryGeneratorService;
...
public class FindByFieldQueryTests {
    ...
    void it_should_generate_find_by_field_query_classes(@TempDir Path tempDir) throws Exception {
        ...
        File file = tempDir.resolve(generatorProperties.getQueryPackage() + "/FindByEmailMockEntityQuery.java").toFile();
        assertThat(file).exists();

        String content = Files.readString(file.toPath());
        assertThat(content).contains("public class FindByEmailMockEntityQuery");
    }
}
