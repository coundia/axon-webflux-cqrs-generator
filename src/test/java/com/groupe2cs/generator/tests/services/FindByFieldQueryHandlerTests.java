...
import com.groupe2cs.generator.service.FindByFieldQueryHandlerGeneratorService;
...
public class FindByFieldQueryHandlerTests {
    ...
    void it_should_generate_find_by_field_query_handler(@TempDir Path tempDir) throws Exception {
        ...
        File file = tempDir.resolve(generatorProperties.getQueryHandlerPackage() + "/FindByEmailMockEntityHandler.java").toFile();
        assertThat(file).exists();

        String content = Files.readString(file.toPath());
        assertThat(content).contains("public class FindByEmailMockEntityHandler");
    }
}
